...
function EventForm({ token }) {
  ...
  return (
    <div className="min-h-screen bg-black text-off-white">
      {/* Header */}
      <div className="border-b-3 border-blood" style={{ padding: '2rem 5vw' }}>
        <div style={{ maxWidth: '900px', margin: '0 auto' }}>
          <div className="flex items-center justify-between">
            <div>
              <p className="font-heading text-sm tracking-[0.3em] text-blood-bright uppercase">Admin Panel</p>
              <h1 className="font-heading text-3xl md:text-4xl font-bold uppercase tracking-tighter">
                MANAGE <span className="text-blood-bright">EVENTS</span>
              </h1>
            </div>
            <span className="px-3 py-1 border-2 border-blood text-blood-bright font-heading text-xs tracking-wider">
              LOGGED IN
            </span>
          </div>
        </div>
